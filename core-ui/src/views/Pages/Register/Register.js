...
linkAadhaar(){
    this.state.web3.eth.getAccounts((error, accounts) => {
        ...
        registerkey(accounts[0],this.state.seedphrase,function(ipfsHash){
            ...
            this.UserDetailsContract.methods.link(this.state.aadhaar, ipfsHash).send({from:accounts[0],gasPrice:this.state.web3.utils.toHex(this.state.web3.utils.toWei('0','gwei'))}, function(error, txHash){ 
                if(!error)  {
              ...
              <Card className="mx-4">
                <CardBody className="p-4">
                  <Form onSubmit={this.SignUp}>
                    ...
                    <Button color="success" type="submit" block>Get OTP</Button>
                  </Form>
                  <br/>
