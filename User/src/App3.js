...
class App extends Component {
  constructor(props) {
    ...
    this.state = {renderNeed: false, needArray: [],
                    renderSign: false, signArray: [],
                  value :'',
                renderViewRecords : false}
    this.addNeed = this.addNeed.bind(this)
    this.addSign = this.addSign.bind(this)
    this.addViewRecords = this.addViewRecords.bind(this)
}
...
addNeed(e) {
  ...
  this.setState({
      ...
      renderSign : false,
      renderViewRecords : false, 
      needArray: [<Login key={Math.random()}/>, ...this.state.needArray],
      value :'<Login/>'
   });
}
...
addSign(e) {
  ...
  this.setState({
    ...
    renderSign: true,
    renderViewRecords : false, 
    needArray: [<SignUp key={Math.random()}/>, ...this.state.needArray],
    value : '<SignUp/>'
 });
}
    ...
    return (
      <div className="App">
        <nav className="navbar pure-menu pure-menu-horizontal">
          ...
          <a href="#" className="pure-menu-heading pure-menu-link" onClick={this.addNeed}>Login</a>
          <a href="#" className="pure-menu-heading pure-menu-link" onClick={this.addSign}>SignUp</a>
          <a href="#" className="pure-menu-heading pure-menu-link" onClick={this.addViewRecords}>View Records</a>
        </nav>
        {this.state.renderNeed ? passNeed : null}
        {this.state.renderSign ? passSign : null}
        {this.state.renderViewRecords ? passViewRecords : null}
